        ...
        <Wrapper id="about-section">
            ...
            <AboutContainer>
                ...
                <AboutTextContainer>
                    ...
                    <p>If you’re interested in what my current tech stack is, I’ve been employing <span>MongoDB</span>, <span>Node.js</span>, and <span>Express</span> to create my RESTful APIs and backend services (toying around with Java and Python occasionally), as well as <span>React</span>, <span>JavaScript</span>, <span>HTML</span>, and <span>CSS</span> for dynamic frontend views. For other tools and technologies, I’m very comfortable with <span>Git</span> and <span>GitHub</span> for version control (worth mentioning that I'm also very passionate about Open Source), and my favourite code editor is <span>Visual Studio Code</span>. Below you can find links to <span>my resume</span>, in both English and Portuguese.</p>
                </AboutTextContainer>
            </AboutContainer>
